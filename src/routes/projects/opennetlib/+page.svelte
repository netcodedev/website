...
<section id="header" class="flex flex-col items-center justify-center gap-4 p-4 text-white">
	<h1 class="text-7xl sm:text-8xl">OpenNetLib</h1>
	<p class="text-center">a Java Networking library</p>
</section>
<section class="flex flex-col gap-4 items-center justify-center p-4">
	<div class="border rounded-lg p-4 w-full max-w-[1000px] flex flex-col gap-4 bg-background">
		...
		<p>
			I built this library in collaboration with ThatsNasu. We wanted to build a simple library,
			that would allow us to easily build server-client applications. We wanted to be able to send
			and receive data, without having to reimpliment the same code over and over again.
		</p>
		<p>
	...
	<div class="border rounded-lg p-4 w-full max-w-[1000px] flex flex-col gap-4 bg-background">
		...
		<ul>
			...
			<li>Data-pre- and -post-processing</li>
