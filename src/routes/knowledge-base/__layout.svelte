<script>
    ...
    // let imports = import.meta.globEager('../../../static/knowledge-base/**/*.md');
    // const posts = [];
...
<style lang="scss">
  ...
  #knowledge-base #search form input, #knowledge-base #search form button {
  ...
  #search-results .search-result ol, #search-results .search-result ul {
    margin: 0px;
  }
...
<div id="knowledge-base">
    <div class="content">
        <h2 id="intro" class="center text-thin">
            This area is home to things I stumbled upon over the time. May it be linux commands I need so rarely
            that I always forget them or neat facts I learned over time. It might start small but could end up huge.
        </h2>
    </div>
    <div id="search">
        <div class="content">
            <form action="/knowledge-base" class="prevent-transitions" autocomplete="off">
                    <input type="search" placeholder="Search through the knowledge base" name="search" value={search}><button><i class="material-icons">search</i></button>
            </form>
        </div>
    </div>
    <slot />
